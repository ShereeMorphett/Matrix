...
if [ "$1" == "clean" ]; then
    ...
    if [ -f ex04_test ]; then
        rm ex04_test
        print_color "cyan" "Deleted compiled executable 'ex04_test'."
    else
        print_color "yellow" "No compiled executable found ('ex04_test')."
    fi
    exit 0
fi

# Compile the C++ code with ex04.cpp
g++ -o ex04_test ex04.cpp -I.
...
declare -a expected_outputs=(
    "Expected Output for Manhattan Norm:
0.0
6.0
3.0"
    "Expected Output for Euclidean Norm:
0.0
3.74165738
2.236067977"
    "Expected Output for Supremum Norm:
0.0
2.0
3.0"
)
